...
public class TodaysTasksFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText(info.getCustomerName());

        jLabel11.setText(info.getAddress());

        jLabel12.setText(info.getPhone());

        jLabel13.setText(info.getMenu());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(gui.changeOrderStatus(info.getOrderID())) {
            ...
            System.err.println("Kunne ikke slette ordre: se TodaysTasksFrame.java");
        }
