...
public class Statistics extends javax.swing.JPanel {
    ...
    public Statistics(final GUI gui) {
        ...
        jLabel6.setText(gui.getYearlyRevenue(currentYear));
        tab1setup();
        addDocumentListener();
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Show only inactive employees");
        ...
        jLabel4.setText("Revenue so far this year:");

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);

        jLabel7.setText("NOK");

        jButton9.setText("Create chart");
        ...
        jLabel8.setText("Revenue in years:");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        gui.byttVindu(this, new TenYearRevenue(gui));
